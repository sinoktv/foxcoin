...
#   c) node1 mines 61 blocks, so now nodes 0 and 1 have 500.000 FOX, node2 has none. 
#   d) node0 sends 210.000 FOX to node2, in two transactions (110.000 FOX, then 100.000 FOX).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210.000 FOX from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1.000.000 FOX in block rewards plus fees, but
        ...
        # Send 100000 FOX with subtract fee from amount
