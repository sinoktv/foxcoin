...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Foxcoin Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  foxcoin-cli [options] <command> [params]  " + _("Send command to Foxcoin Core") + "\n" +
                  "  foxcoin-cli [options] help                " + _("List commands") + "\n" +
                  "  foxcoin-cli [options] help <command>      " + _("Get help for a command") + "\n";
