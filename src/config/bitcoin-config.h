...
#define PACKAGE_BUGREPORT "https://github.com/foxcoin/foxcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Foxcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Foxcoin Core 1.10.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "foxcoin"
