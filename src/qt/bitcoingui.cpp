...
// Copyright (c) 2014-2015 The Foxcoin Core developers
    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Foxcoin Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    // Foxcoin: load fallback font in case Comic Sans is not availble on the system
    ...
    // Foxcoin: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // Foxcoin: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Foxcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and foxcoin: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About Foxcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Foxcoin Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(platformStyle->TextColorIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->TextColorIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Foxcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Foxcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Foxcoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Foxcoin Core help message to get a list with possible Foxcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Foxcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Foxcoin network", "", count));
}
...
{
    QString strTitle = tr("Foxcoin"); // default title
