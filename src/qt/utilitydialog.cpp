    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Foxcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Foxcoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  foxcoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Foxcoin Core is shutting down...") + "<br /><br />" +
