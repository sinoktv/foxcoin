...
QString BitcoinUnits::name(int unit)
{
    ...
    case mBTC: return QString("mFOX");
    case uBTC: return QChar(0x03BC) + QString("FOX");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MBTC: return tr("Mega-Foxcoins (1,000,000)");
    case kBTC: return tr("Kilo-Foxcoins (1,000)");
    case BTC: return tr("Foxcoins");
    case mBTC: return tr("Milli-Foxcoins (1 / 1,000)");
    case uBTC: return tr("Micro-Foxcoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
