    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int titleCopyrightVSpaceFOX = 40;
    ...
    QString titleText       = tr("Foxcoin Core");
    ...
    QString copyrightTextFOX  = QChar(0xA9)+QString(" 2013-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Foxcoin Core developers"));
    ...
    pixPaint.setFont(QFont(font, 10*fontFactor));
    pixPaint.drawText(pixmap.width()/devicePixelRatio-titleTextWidth-paddingRight,paddingTop+titleCopyrightVSpaceFOX,copyrightTextFOX);
