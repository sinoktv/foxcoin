...
const QString BITCOIN_IPC_PREFIX("foxcoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/foxcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/foxcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/foxcoin-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start foxcoin: click-to-pay handler"));
        }
        else {
