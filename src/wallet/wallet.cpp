        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            while (true)
            {
                ...
                *static_cast<CTransaction*>(&wtxNew) = CTransaction(txNew);
                ...
                // Foxcoin: Disable free transactions
...
{
    // Foxcoin: Round TX bytes up to the next 1,000 bytes
    ...
    if (nFeeNeeded == 0) {
        ...
        // Foxcoin: Add an increased fee for each dust output
        nFeeNeeded += GetFoxcoinDustFee(tx.vout, minTxFee);
    }
