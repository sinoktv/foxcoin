...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Foxcoin Core foxcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  foxcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded foxcoin transaction") + "\n" +
              "  foxcoin-tx [options] -create [commands]   " + _("Create hex-encoded foxcoin transaction") + "\n" +
              "\n";
